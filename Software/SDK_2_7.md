...
New functions :
- cmd_ir.c Added : rc_unmute_ir_handler, rc_mute_ir_handler, rc_start_handler and rc_reboot_handler.
- cmd_pogobot.c : Added is_muted_handler.

New RC commands :
- is_muted  : Checks whether the PogoBot is muted or not.
- rc_mute_ir   : Stops all IR emissions.
- rc_unmute_ir : Restarts all IR emissions.
