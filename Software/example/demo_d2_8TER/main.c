...
/** \file
 * Pogobot demo source code D2.8 TER.
 * This file implements "D2.8 TER Testing photosensor : phototaxis".
 * 
 ...
 *   and moves proportionally to the light
...
main(void) {
    ...
    {    
        ...
        max_val = max_val*10;
        printf( "moving at %u\n", max_val);
        pogobot_motor_set( motorR, max_val );
        pogobot_motor_set( motorL, max_val );
