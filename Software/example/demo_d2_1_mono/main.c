...
/** \file
Pogobot demo source code D2.1, one-robot version.

This file implements the one-robot version of demo "D2.1 Testing
    ...
    while (1)
    {
        ...
        if ( pogobot_infrared_message_available() )
        {
            while ( pogobot_infrared_message_available() )
            {
                ...
                int color_index = mr.header._receiver_ir_index;
